...
public class analysis {
    static Map<String, Vertex> track=new TreeMap<>();
    ...
    public static void queryGraph(Graph graph, Scanner sn){
        ...
        while(true) {
            ...
            if (in.endsWith("?")) {
                ...
                v0 = new Vertex(args[1]);
                v1 = new Vertex(args[2]);
                if (args[0].equals("ci")) {
                    System.out.println("commonInfluencers " + Algorithms.commonDownstreamVertices(graph, v0, v1));
                } else if (args[0].equals("nr")) {
                    System.out.println("numRetweets " + Algorithms.shortestDistance(graph, v0, v1));
                }
            }else if(in.equals("print")){
                printGraph(graph);
                System.out.println("down v0 "+graph.getDownstreamNeighbors(v0));
                System.out.println("down v1 "+graph.getDownstreamNeighbors(v1));
            }
